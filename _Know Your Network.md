...
Task:
 1. CoreTAAS must have the following SVIs
   - VLAN 1
       - IP address: 10.82.1.2
       - Description: DEFAULT-VLAN
       - Status: UP

   - VLAN 10
     - IP address: 10.82.10.2
...
conf t
 ...
 ip dhcp excluded-address 10.82.50.1 10.82.50.100
 ...
 ip dhcp pool POOLWIFI
  ...
  dns-server 10.82.1.10
  option 43 ip 10.82.10.82
 ip dhcp pool POOLCCTV
  network 10.82.50.0 255.255.255.0
  default-router 10.82.50.4
...
!@CoreBABA
conf t
 ip dhcp excluded-address 10.82.100.1 10.82.100.100
 ip dhcp pool POOLVOICE
  network 10.82.100.0 255.255.255.0
  default-router 10.82.100.4
  domain-name VOICEDATA.COM
  dns-server 10.82.1.10
  option 150 ip 10.82.100.8
  lease 5 0 0
  end
~~~
...
conf t
 ...
 ip dhcp pool CAMERA6
  host 10.82.50.6 255.255.255.0
  client-identifier #camera6macadd#
 ip dhcp pool CAMERA8
  host 10.82.50.8 255.255.255.0
...
!@dhcp
conf t
 ip dhcp excluded-add 10.82.1.1 10.82.1.100
 ip dhcp excluded-add 10.82.10.1 10.82.10.100
 ip dhcp excluded-add 10.82.50.1 10.82.50.100
 ip dhcp excluded-add 10.82.100.1 10.82.100.100
 ip dhcp pool POOLDATA
  network 10.82.1.0 255.255.255.0
  default-router 10.82.1.4
  domain-name MGMTDATA.COM
...
conf t
 ...
 telephony-service
  ...
  max-ephones 5
  max-dn 20
  ip source-address 10.82.100.8 port 2000
  end
~~~

<br>

*Why 10.82.100.8? __TFTP__*
...
conf t
 ...
 ip route 10.82.0.0 255.255.0.0 10.82.82.4 254
 end
~~~
...
conf t
 ip routing
 ip route 0.0.0.0 0.0.0.0 10.82.100.4 254
 end
~~~
...
!@CoreBABA
conf t
 ip route 0.0.0.0 0.0.0.0 10.82.82.1 254
 end
~~~
...
network 82.0.0.1 0.0.0.0 area 0
int gi 0/0/0
...
conf t
router ospf 1
router-id 10.82.82.4
network 10.82.0.0 0.0.255.255 area 0
int gi0/1
ip ospf network point-to-point
~~~
...
conf t
router ospf 1
router-id 10.82.100.8
network 10.82.100.0 0.0.0.255 area 0
end
~~~
...
~~~
!@cmd
ping 10.82.1.2                 CoreTAAS
ping 10.82.1.4                 CoreBABA
ping 10.82.100.8               CUCM
ping 10.82.82.1            EDGE
~~~
